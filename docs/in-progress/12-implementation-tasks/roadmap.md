...
| 5+    | Audio data routing (AudioWorklet + offscreen MediaStream) | 🟡 ~80% (offscreen で MediaStream 確保まで到達)      |
...
#### Phase 5+ Step 2b-2b: offscreen-audio-host に TabStreamApi 配線 (✅ 完了, IMPL-612, 本 PR)
